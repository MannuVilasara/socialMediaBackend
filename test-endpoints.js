...
/**
 * Working API Endpoint Testing Script
 * Tests all endpoints in the Social Media Backend using axios
 */
...
async function testToggleSubscription() {
    ...
    const dummyChannelId = new mongoose.Types.ObjectId().toString();
...
async function testGetChannelSubscribers() {
    // Test getting our own subscribers (empty list)
...
async function testGetSubscribedChannels() {
    // Test getting channels we subscribe to (empty list)
